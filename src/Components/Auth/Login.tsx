...
import { UserCredentials } from '../JSON_Data/UserCredentials'; // ✅ Import static JSON
  ...
  const handleSignIn = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (foundUser) {
      if (foundUser.role === 'Admin') {
        ...
        showToast(false, 'Access denied: Not an admin');
      }
    } else {
      showToast(false, 'Invalid mobile number or password');
    }
