...
const Usermanagement = () => {
  ...
  const {data,loading}:any= useSelector((state: RootState) => state.UserMangment);
  ...
  const TotalUsers = Math.ceil(data?.totalUsers / data?.limit);
                      ...
                      <tr key={tdata._id}>
                        <td>
                          {sort === 'desc'
                            ...
                            : data.totalUsers - ((page - 1) * limit + index)}
                        </td>
